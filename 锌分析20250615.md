...
<font color = red>国内周度库存重新去0.2w，主要因为下跌中补库，但是镀锌板开工开始季节性下滑且压铸库存并不低，预计后续几周去库不可持续。六月冶炼排产预计大增4w，后续冶炼产量难以下降；加工环节开工率稳定见顶；**本周五随着锌价下跌LME结构走强至-20c附近。**</font>
...
- 本周主要逻辑变化：中期策略维持不变，<font color = red>周度库存-0.2w，累库主要因为下游逢低补库，预计接下去几周重回累库，锌精矿加工费本周不变。</font>目前SMM调研5月库存基本平衡（社库去库+冶炼厂库存增加），1-5累计表消+2%；目前加工费已经全面反弹到3600以上，czspt三季度指导价比现货高40美金，冶炼厂六月随着检修结束和新投项目，矿加速从港口到厂库转移，六月预计累库3w左右。

- 周度数据更新：<font color = red>**数据整体偏中性：本周精炼库存走势符合季节性，升贴水下跌速度显著放缓；压铸板块或仍有抢出口**</font>
- - <font color = red>锌精矿港口库存环比-2.7w，去库幅度放缓，目前绝对库存水平仍历史最高。</font>
